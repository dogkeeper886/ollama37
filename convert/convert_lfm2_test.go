...
func TestLFM2DenseKV(t *testing.T) {
	p := lfm2Model{
		ModelParameters: ModelParameters{VocabSize: 32000}, ModelType: "lfm2",
		HiddenSize:            1024,
		NumHiddenLayers:       2,
...
func TestLFM2KVContextLengthEdgeCaseFallbackOverride(t *testing.T) {
	p := lfm2Model{
		ModelParameters: ModelParameters{VocabSize: 65536}, ModelType: "lfm2_moe",
		HiddenSize:            2048,
		NumHiddenLayers:       40,
...
func TestLFM2KVFeedForwardLengthAutoAdjust(t *testing.T) {
	p := lfm2Model{
		ModelParameters: ModelParameters{VocabSize: 65536}, ModelType: "lfm2",
		HiddenSize:            2048,
		NumHiddenLayers:       16,
		MaxPositionEmbeddings: 128000,
